...
-- ============================================================================
-- Этот файл описывает РАННЮЮ модель (markets.id TEXT, clients.telegram_id,
-- таблицы services/messages), которая НЕ соответствует боевой БД
-- cmmdrhususjuadqzyssc. Боевая схема: markets.id BIGINT, clients.tg_chat_id,
-- таблица tours (не services), conversations (не messages). Источник правды —
-- сама БД (см. миграции 004/005 + интроспекция). Оставлен только как история.
-- Применение этого файла поверх прода СЛОМАЕТ систему.
-- ============================================================================
-- Нестандартный Отдых — Supabase Schema (LEGACY)
-- ============================================================================
